q_toxo="
select max(bs.score) score, chembl_id, target_type, organism, targets.tax_id, targets.targ_comp
from
(select distinct td.chembl_id, td.target_type, td.organism, td.tax_id, bs.targ_comp
...
group by chembl_id, target_type, organism, targets.tax_id, targets.targ_comp
order by score desc
"
